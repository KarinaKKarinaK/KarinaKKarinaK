...
LIGHT = dict(data="#6e7681", emph="#b8250f", dim="#8c959f",
             rule="#d8dee4", surface="#ffffff")
DARK = dict(data="#c9d1d9", emph="#e63a24", dim="#8b949e",
...
def main():
    ...
    login = os.environ.get("GH_LOGIN", "KarinaKKarinaK")
    ...
    for word in ("about", "stack", "projects", "research", "stats", "about this page"):
